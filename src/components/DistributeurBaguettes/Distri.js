...
const DistriBaguettes = () => {
  ...
  return (
    <section ref={ref} className={`${styles.productSection} ${isInView ? styles.inView : ''}`}>
      <div className={styles.productContent}>
        <div className={`${styles.textContent} ${isInView ? styles.inView : ''}`}>
        ...
        <div className={`${styles.imageContainer} ${isInView ? styles.inView : ''}`}>
